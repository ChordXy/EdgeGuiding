...
public:
    explicit calibrationDialog(AppConfigs ac, performAlgorithms *tAlgorithm, PlatformOperator *lOpt, QWidget *parent = nullptr);
    ~calibrationDialog();
...
private:
    ...
    QPixmap curPix;
    QPen dashPenY, dashPenW, dashPenR, linePenR;
    QFont font;

    PlatformOperator *ledOpt;
    char duty_light[10];
